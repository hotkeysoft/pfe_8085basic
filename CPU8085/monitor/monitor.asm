...
;CONSOLE: SWITCH TO CONSOLE TESTING MODE
	CALL	CONSOLE
...
6$:
	...
	LXI	H,FGSTR		;PRINT FOREGROUND STRING
	CALL	LCDPUTS
	
	CALL	GETBYTE		;GET FG COLOR # IN A
	JNC	100$		;CY = 0 IF FAILED
...
7$:
	...
	LXI	H,BGSTR		;PRINT BACKGROUND STRING
	CALL	LCDPUTS
	
	CALL	GETBYTE		;GET BG COLOR # IN A
	JNC	100$		;CY = 0 IF FAILED
...
8$:
	...
	LXI	H,GOTOXSTR	;PRINT GOTOX STRING
	CALL	LCDPUTS
	
	CALL	GETBYTE		;GET X POSITION # IN A
	JNC	100$		;CY = 0 IF FAILED
	
	mov	D,A

	LXI	H,GOTOYSTR	;PRINT GOTOY STRING
	CALL	LCDPUTS
	
	CALL	GETBYTE		;GET Y POSITION # IN A
	JNC	100$		;CY = 0 IF FAILED
...
CONSOLESTR:	.asciz	'Console - ESC: back'

FGSTR:		.asciz	'Foreground: '
BGSTR:		.asciz	'Background: '

GOTOXSTR:	.asciz	'GotoXY - X: '
GOTOYSTR:	.asciz	'         Y: '
