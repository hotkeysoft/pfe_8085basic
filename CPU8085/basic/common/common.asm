...
C_NAME2TAG::
	...
	JNC	error		; 1ST CHAR MUST BE LETTER
	...
	CPI	'$		; CHECK IF STRING
	JZ	EOS		; END OF STRING VARIABLE
	
	CALL	C_ISALPHA	; CHECK IF ALPHA
	JC	ADDLETTER	; PART OF VARIABLE NAME
...
EOS:	; END OF THE VARIABLE NAME (STRING)
	INX	H		; HL++
