...
;*		BC CONTAINS LINE NUMBER, -1 IF BEGIN
PRG_RUN::
	CALL	PRG_CLR				; CLEAR VARIABLES, STRING

	MOV	A,B				; CHECK IF NUMBER IS NEGATIVE
	ORA	A				; IF SO, RUN FROM BEGINNING
	JM	BEGIN
...
LOOP:
	...
	MVI	E,0x01				; IF STEP IF POSITIVE, E=0x01
	ORA	A
	JP	POS
	
	MVI	E,0xFF				; STEP IS NEGATIVE
