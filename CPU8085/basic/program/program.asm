...
PRG_GOSUB::
	...
	MOV	A,L
	STA	PRG_TEMPGOSUB+1			; STORE IN TEMP VAR
	...
	MOV	A,L
	STA	PRG_TEMPGOSUB+3			; STORE IN TEMP VAR
...
1$:	; IMMEDIATE MODE
	MVI	A,0				; FILL DATA TO BE PUSHED
	STA	PRG_TEMPGOSUB+1			; ON THE STACK
	STA	PRG_TEMPGOSUB+2
	STA	PRG_TEMPGOSUB+3
...
PRG_TEMPGOSUB:		.ds	5		; USED BY PRG_GOSUB