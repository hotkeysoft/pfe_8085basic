...
8$:	; IF
	CALL	EXP_DO_IF
	JC	102$				; EXIT IF RETURNED 1
	JMP	100$				; ELSE CONTINUE
...
;*		IN: C = EXECUTE
;*		OUT: CF=0/1 DEPENDING OF EXECUTE() RESULT
EXP_DO_IF:
	PUSH	B
