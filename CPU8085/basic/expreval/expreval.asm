...
EXP_DO_FOR::
	...
	PUSH	H			; KEEP POSITION
	
	; TAKE THE OCCASION (SINCE HL IS FREE) TO SET 'STEP' VALUE TO 1
	LXI	H,1
	SHLD	INT_ACC2		; STORE '1' IN INT_ACC2
	...
	LHLD	VAR_TEMP1+1		; READ BEGIN VALUE IN HL
	SHLD	INT_ACC0		; STORE IN INT_ACC0
	...
	LHLD	VAR_TEMP1+1		; READ END VALUE IN HL
	SHLD	INT_ACC1		; STORE IN INT_ACC1
	...
	LHLD	VAR_TEMP1+1		; READ END VALUE IN HL
	SHLD	INT_ACC2		; STORE IN INT_ACC2
