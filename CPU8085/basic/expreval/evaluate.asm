...
6$:	; OPERATION ON STRINGS
	...
	JC	ERR_STRTOOLONG		; CHECK FOR OVERFLOW
...
EVAL_BINARYLOG::
	LDA	VAR_TEMP1			; TYPE OF VAR1 IN ACC
	CPI	SID_CINT
	JNZ	ERR_TYPEMISMATCH		; MUST BE INTEGER
...
EVAL_LEN::
	LDA	VAR_TEMP1			; TYPE OF VAR1 IN ACC
	CPI	SID_CSTR
	JNZ	ERR_TYPEMISMATCH		; MUST BE STRING
...
;*********************************************************
;* EVAL_FRE: 	RETURNS FREE MEMORY (INT)
;*		CALCULATED AS BOTTOM OF STR ARA
;*		MINUS TOP OF VARIABLE AREA
EVAL_FRE::
	LDA	VAR_TEMP1			; TYPE OF VAR1 IN ACC
	CPI	SID_CINT
	JNZ	ERR_TYPEMISMATCH		; MUST BE INTEGER
	
	CALL	STR_GARBAGECOLLECTION		; CLEAN-UP STRING AREA
	
	LHLD	STR_LOPTR			; BOTTOM OF STR PTR
	SHLD	INT_ACC0			; IN INT_ACC0
	
	LXI	H,VAR_HIPTR			; HL POINTS TO TOP OV VAR MEM
